...
%[CL] = CCA1 and LHY
dy1dt = (v1+v1L*L*y(9))*(1/(1+(y(4)/K1)^2 + (y(6)/K2)^2))-(k1L*L+k1D*D)*y(1);
dy2dt = (p1+p1L*L)*y(1) - d1*y(2);
...
F = [dy1dt; dy2dt; dy3dt; dy4dt; dy5dt; dy6dt; dy7dt; dy8dt; dy9dt];
end